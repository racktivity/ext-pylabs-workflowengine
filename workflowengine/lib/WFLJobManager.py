...
import json
from pylabs.baseclasses.BaseEnumeration import BaseEnumerationMeta
...
class WFLJob:
    ...
    def __init__(self, parentjob=None, actionName=None, executionparams=None, agentguid=None, params=None):
        """
