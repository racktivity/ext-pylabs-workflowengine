...
class WFLActionManager():
    ...
    def __execute(self, parentTasklet, jobguid, params, tags, path):
        #SETUP THE CONTEXT
        alog("new TASKLETACTION tags %r"%jobguid)
        ...
        try:
            alog("new TASKLETACTION eXECUTE task %r"%jobguid)
